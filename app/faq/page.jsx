...
const FAQPage = () => {
  ...
  const metadata = {
    title: "Часто задаваемые вопросы | Сантехник & Электрик Тюмень ",
    description:
    ...
    keywords: [
      "вопросы о сантехнике Тюмень", 'Сантехник & Электрик ','Сантехник & Электрик ', "Электрик Тюмень " ,"Сантехник Тюмень",
      "часто задаваемые вопросы сантехник",
